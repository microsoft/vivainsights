...
- **Y-axis** — probability of *not yet* having experienced the event (survival probability).
- **X-axis** — week number (time since the start of observation).
- **Each step down** marks one or more events in that group at that week.
- **Curves that drop quickly** indicate groups where the event occurs early.
- **Curves that stay high** indicate groups where many people never experience the event (or experience it late).
