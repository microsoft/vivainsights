...
Analyzes a selected metric and returns a 'fizzy' scatter plot by
default. Additional options available to return a table with
...
package that produce 'fizzy drink' / jittered scatter plots.
