...
default returns a week by week heatmap bar plot, highlighting the points
in time with most activity. Additional options available to return a
summary table.
...
- palette:
  ...
  Character vector containing colour codes, ranked from the lowest value
  to the highest value. This is passed directly to
