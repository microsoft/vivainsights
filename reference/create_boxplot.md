...
Analyzes a selected metric and returns a box plot by default. Additional
options available to return a table with distribution elements.
...
package that produce box plots.
