...
Provides a week by week view of 1:1 time with managers, visualised as
line charts. By default returns a line chart for 1:1 meeting hours, with
a separate panel per value in the HR attribute. Additional options
...
- label:
  ...
  plot. If `TRUE`, both `geom_point()` and `geom_text()` are added to
...
#> 1 Executive            0.907        0.974        1.08         0.905        0.846
#> 2 Junior IC            0.962        0.879        0.981        0.820        1.09 
#> 3 Senior IC            0.747        1.07         0.908        0.947        1.05 
#> 4 Senior Manag…        0.834        0.866        0.817        0.975        0.903
