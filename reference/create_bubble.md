...
Returns a bubble plot of two selected metrics, using size to map the
number of employees.
...
- bubble_size:
  ...
  A numeric vector of length two to specify the size range of the
  bubbles
...
package that produce bubble plots.
