...
Create a two-series line chart that visualizes a set of metric over time
for the selected population, with one of the series being a four-week
rolling average.
...
- metric:
  ...
  "Collaboration_hours" percentage signs. Defaults to `FALSE`.
