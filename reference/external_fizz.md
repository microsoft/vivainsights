...
Analyze weekly External Collaboration hours distribution, and returns a
'fizzy' scatter plot by default. Additional options available to return
a table with distribution elements.
...
#> 1 Finance     8.97   8.96 0.807  7.60 10.6   3.04    68
#> 2 HR          8.91   8.86 0.602  7.89 10.00  2.11    33
#> 3 IT          8.82   8.80 0.941  6.95 11.7   4.80    68
#> 4 Legal       8.63   8.60 0.798  7.16 10.1   2.94    44
#> 5 Operations  9.27   9.04 0.952  7.32 10.9   3.54    22
#> 6 Research    9.11   9.18 0.861  7.06 10.6   3.50    52
#> 7 Sales       9.01   9.15 0.673  7.94 10.1   2.15    13
```
