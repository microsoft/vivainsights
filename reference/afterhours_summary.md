...
Provides an overview analysis of after-hours collaboration time. Returns
a bar plot showing average weekly after-hours collaboration hours by
default. Additional options available to return a summary table.
...
#>   <chr>                                    <dbl> <int>
#> 1 Executive                                 6.87    37
#> 2 Junior IC                                 7.18   136
#> 3 Senior IC                                 6.81    87
#> 4 Senior Manager                            7.39    40
```
