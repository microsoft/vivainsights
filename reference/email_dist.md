...
Analyze Email Hours distribution. Returns a stacked bar plot by default.
Additional options available to return a table with distribution
elements.
...
#> # A tibble: 7 × 3
#>   group      `1.5+ hours` Employee_Count
#>   <fct>             <dbl>          <int>
#> 1 Finance               1             68
#> 2 HR                    1             33
#> 3 IT                    1             68
