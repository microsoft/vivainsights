...
Returns a stacked bar plot by default. Additional options available to
...
- cut:
  ...
  A vector specifying the cuts to use for the data, accepting "default"
  or "range-cut" as character vector, or a numeric value of length three
  to specify the exact breaks to use. e.g. c(1, 3, 5)
